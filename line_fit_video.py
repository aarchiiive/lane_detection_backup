...
def annotate_image(img_in):
	...
	binary_warped, binary_unwarped, m, m_inv = perspective_transform(img)
 	...
 	##############################################################################
	###############################TODO###########################################
	ret, detected = line_fit(binary_warped)
...
if __name__ == '__main__':
	# Annotate the video
	# annotate_video(os.getcwd() + '/advanced_lane_detection/drive.mp4', os.getcwd() + '/advanced_lane_detection/out2.mp4')
	# annotate_video('project_video.mp4', 'out.mp4')
	# annotate_video('kcity2.mkv', 'out2.mp4')
